...
# Complex commands section
    ...
    def readMemory(self, addr, lng):
        ...
        while lng > 256:
            ...
            addr = addr + 256
            lng = lng - 256
        mdebug(5, "Read %(len)d bytes at 0x%(addr)X" % {'addr': addr, 'len': lng})
    ...
    def writeMemory(self, addr, data):
        ...
        while lng > 256:
            ...
            addr = addr + 256
            lng = lng - 256
        mdebug(5, "Write %(len)d bytes at 0x%(addr)X" % {'addr': addr, 'len': lng})
...
# http://www.python.org/doc/2.5.2/lib/module-getopt.html
    ...
    try:
        try:
            ...
            print "Can't init. May be already running?"
